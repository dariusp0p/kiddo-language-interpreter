...
public class Main {
    public static void main(String[] args) throws AdtException {
        ...
        // Example 12
        Statement ex12 = ProgramExamples.example12();
        ProgramState prg12 = new ProgramState(
                new DequeExecutionStack(),
                new MapSymbolTable(),
                new ListOutput(),
                new MapFileTable(),
        ...
        // Example 13
        Statement ex13 = ProgramExamples.example13();
        ProgramState prg13 = new ProgramState(
                new DequeExecutionStack(),
                new MapSymbolTable(),
                new ListOutput(),
                new MapFileTable(),
        ...
        // Example 14
        Statement ex14 = ProgramExamples.example14();
        ProgramState prg14 = new ProgramState(
                new DequeExecutionStack(),
                new MapSymbolTable(),
                new ListOutput(),
                new MapFileTable(),
